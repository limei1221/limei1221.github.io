...
### Gumbel-softmax
The author use gumbel-softmax relaxtion (introduced in paper [Categorical reparameterization with gumbel-softmax](https://arxiv.org/abs/1611.01144)) to address the problem of the sampling step is not differentiable.
