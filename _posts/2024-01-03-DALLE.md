...
Fix dVAE parameters, concatenate up to 256 BPE-encoded text tokens with the 32 x 32 = 1024 image tokens (vocabulary size 16,384), and train an autoregressive transformer to model the joint distribution over the text and image tokens.
